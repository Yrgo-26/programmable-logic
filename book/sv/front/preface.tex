...
Behöver något av det fräschas upp står allt i \debook{}
(\url{https://github.com/qrtech-academy/digital-electronics}), en fritt tillgänglig bok på engelska
som går från en enda grind till en tillståndsmaskin: grindar och boolesk algebra i kapitel~1 och~2,
Karnaughdiagram i kapitel~3, vippor och register i kapitel~5 och tillståndsmaskiner i kapitel~6.
Kapitlen i den här boken hänvisar dit där de repeterar grunderna, och \secref{app:reading:basics}
har hela kartan.
...
\textbf{Git och GitHub} förutsätts inte. Kursen går igenom dem från grunden i passet som hör till
\chapref{c11:ch}, innan grupprojektets första Pull Request; boken behandlar dem inte.
...
CAN-nod; protokollet självt beskrivs i \canbook, en kort bok skriven för båda halvorna av ett
CAN-system, på svenska och på engelska med samma kapitelnumrering. Den är protokollreferensen genom
hela andra halvan: dess kapitel 1--6 är kravspecifikationen för det som byggs här, bit för bit, och
dess kapitel~7 beskriver precis den förenklade kontroller del~\ref{part:can} landar i. Varje kapitel
som lägger till en protokollregel säger var i den boken regeln står, och
\secref{app:reading:protocol} har hela kapitelkartan mellan de två. Läs gärna dess kapitel 1 och 2
innan \chapref{c10:ch}; resten fungerar bäst som uppslagsverk.
