...
utesluten kategori vad som utesluter den: antingen ett av de tre villkoren i
\secref{c16:sec:crcfeed}:s regel för \code{crc_enable} (\code{txsr_bit_valid}, \code{txsr_stuff} och
\code{role}), eller det faktum att fältet aldrig passerar genom \code{tx_shift_reg} över huvud taget.
