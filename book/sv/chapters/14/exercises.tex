...
analysera filen. Den kompilerar inte; läs de fyra felen innan du går vidare. Gör sedan en version på
arkitektursnivå som \emph{faktiskt} kompilerar, med identiskt beteende och en testbänk som passerar.
Jämför de två anropsställena och säg vad den andra versionen kostar, och vilken ny fråga den väcker
som versionen inuti processen inte kan väcka.
