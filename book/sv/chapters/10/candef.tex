% Avsnitt 10.8, ur lectures/L10/appendix/b_can_def_package.md.
...
Utdelat, i \file{controller/can_def.vhd}, och genomgånget på tavlan under passet. Paketet är en del
av kontraktet och inte något att konstruera: sex av de utdelade testbänkarna läser dess namn och
typer direkt, så det läggs in i gruppens repo \textbf{oförändrat}, precis som testbänkarna. Varje
modul du skriver från \chapref{c11:ch} och framåt hamnar i samma katalog, och alla utom
\code{meta_prev} läser den här enda filen.
