% Bilaga E: vidare läsning. Protokollreferensen först, sedan standarderna, verktygen och fyra
...
på andra sidan SPI-länken skrivs av någon annan. Den här bilagan säger var protokollet självt står
beskrivet, vilka standarder konstruktionen förhåller sig till, och vart man går härnäst.
...
Den är kort, på svenska, och skriven för båda halvorna av ett CAN-system: den som bygger kontrollern
i hårdvara och den som skriver drivrutinen i mjukvara. Den nämner därför varken kurs eller klass, och
den är avsiktligt oberoende av vilken av de två kurserna som läser den.
...
den beskriver standarden på svenska och i den detaljnivå en konstruktör behöver. Vill du därefter se
vad som faktiskt står i originalet:
