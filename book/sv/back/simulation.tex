...
per pass och ingenting att kopiera mellan dem; \file{can_def.vhd} i synnerhet är utdelad,
finns \emph{en} gång, och varje kontrollermodul läser den enda filen.
...
\begin{textdrawing}
controller/   can_controller.vhd     kap 11, din (först bara portar, växer genom kap 17)
...
De två katalogerna innehåller från början bara de utdelade filerna: nio testbänkar, plus
\file{can_def.vhd}, \file{spi_slave.vhd} och \file{spi_def.vhd}. Varje kapitel från \chapref{c11:ch}
lägger till en modul, med undantaget att \file{can_controller.vhd} skrivs tidigt (\chapref{c11:ch}) som en entitet
...
kvar att göra. \file{can_def.vhd} namnges aldrig som saknad, eftersom den är utdelad.
