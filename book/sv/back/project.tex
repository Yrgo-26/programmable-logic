...
Utdelat, i \file{controller/can_def.vhd}, genomgånget i \chapref{c10:ch}, och läst av allt annat.
Paketet läggs in oförändrat: sex av de utdelade testbänkarna läser dess namn och typer, så det är en
del av kontraktet och inte något gruppen konstruerar.
