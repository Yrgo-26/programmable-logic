...
\textbf{Git and GitHub} are not assumed. The course teaches them from scratch in the session that
goes with \chapref{c11:ch}, before the group project's first pull request; the book does not cover
them.
