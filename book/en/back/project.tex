...
Handed out, in \file{controller/can_def.vhd}, presented in \chapref{c10:ch}, and read by everything
else. The package goes in unchanged: six of the testbenches handed out read its names and types, so
it is part of the contract and not something the group designs.
...
The values, for a DE0-CV with a 50 MHz system clock and CAN at 1 Mbit/s:
